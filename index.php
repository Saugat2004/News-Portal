        ...
        <div class="nav-container">
            ...
            <div class="nav-links">
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <span class="welcome">Welcome, <?php echo htmlspecialchars($_SESSION['user_name']); ?>
                        (<?php echo htmlspecialchars($_SESSION['user_role'] ?? 'user'); ?>)</span>
    ...
    <div class="news-container">
        ...
        <div class="news-grid">
            <?php foreach ($news_list as $article): ?>
                ...
                <article class="news-card" onclick="location.href='newspage.php?id=<?php echo $article['id']; ?>';"
                    style="cursor: pointer;">
                    <img src="<?php echo htmlspecialchars($banner); ?>" alt="News Image">
                    <div class="news-content">
                        <h3><?php echo htmlspecialchars($article['title']); ?></h3>
                        <p class="description">
                            <?php echo htmlspecialchars(substr($article['description'], 0, 100)) . '...'; ?></p>
                        <div class="news-meta">
                        ...
                        <?php if (isset($_SESSION['user_id']) && (($_SESSION['user_role'] ?? 'user') === 'admin')): ?>
                            <div style="margin-top: 12px;">
                                <a href="editnews.php?id=<?php echo $article['id']; ?>" class="indexback-btn"
